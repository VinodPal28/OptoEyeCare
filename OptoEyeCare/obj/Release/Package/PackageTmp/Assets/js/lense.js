$(document).ready(function (e) {
    ...
    $("body").on("click", "#tabledata .Update", function () {
        ...
        Data.lenseName = row.find(".lenseNameValue").find("span").html();
        $.ajax({
            async: true,
            type: 'POST',
            dataType: 'JSON',
